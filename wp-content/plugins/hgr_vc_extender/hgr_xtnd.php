	...
	*/
	function hgr_vc_dependency_check() {
		if ( is_plugin_active( 'js_composer/js_composer.php' ) ) {
			...
			*/
			if( version_compare( '4.3.1', WPB_VC_VERSION, '>' ) ) {
				/*
	...
	function vc_installed_min_version_notice() {
		return '<div class="hgr_notice hgr_notice_error"><p><strong>HighGrade Extender is a add-on for Visual Composer plugin</strong>, therefore before activation of HighGrade Extender please install and activate Visual Composer - <strong>minimum version: 4.0.5</strong></p></div>';
	}
	...
	function hgr_xtnd_install(){
		update_option('hgr_xtnd_version', '1.1.4' );
	}
