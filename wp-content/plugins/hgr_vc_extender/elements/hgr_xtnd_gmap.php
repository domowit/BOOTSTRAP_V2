					...
					array(
					   ...
					   "params" => array(
							...
							array(
								...
								"value"			=>	array(	
										"Google preset colors"	=>	"gmap_style_normal",
										"Greyscale"				=>	"gmap_style_greyscale",
									),
							...
							array(
								...
								"value"			=>	array(	
										"Google default"	=>	"gmap_marker_default",
										"Plugin default"	=>	"gmap_marker_plugin",
										"Upload your own"	=>	"gmap_marker_custom",
									),
