					   ...
					   "params"		=>	array(
							...
							*/
							array(
								...
								"value"			=>	array(
										"Top"					=>	"icon_front_top",
										"Bottom"				=>	"icon_front_bottom",
										"Just icon, no text"	=>	"icon_front_notext",
								),
							...
							*/
							array(
								...
								"value"			=>	array(
										"None"						=>	"none",
										"Select background color"	=>	"icon-background-select",
									),
							...
							*/
							array(
								...
								"value"			=>	array(	
										"No icon"				=>	"no_icon_back",
										"Top position"			=>	"top_icon_back",
										"Bottom position"		=>	"bottom_icon_back",
										"Just icon, no text"	=>	"notext_icon_back",
									),
							...
							*/
							array(
								...
								"value"			=>	array(
										"None"						=>	"none",
										"Select background color"	=>	"bpicon-background-select",
									),
								"description"	=>	__("Select background settings for your icon.","hgr_lang"),
								"dependency"	=>	array(
										"element"	=>	"icon_type_back",
							...
							*/
							array(
								...
								"value"			=>	array(
										"None"			=>	"none",
										"Select color"	=>	"custom-front-color",
									),
							...
							*/
							array(
								...
								"value"			=>	array(
										"None"						=>	"none",
										"Custom border settings"	=>	"custom-front-border",
									),
							...
							*/
							array(
								...
								"value"			=>	array(
										"None"			=>	"none",
										"Select color"	=>	"custom-back-color",
									),
							...
							*/
							array(
								...
								"value"			=>	array(
										"None"						=>	"none",
										"Custom border setttings"	=>	"custom-back-border",
									),
